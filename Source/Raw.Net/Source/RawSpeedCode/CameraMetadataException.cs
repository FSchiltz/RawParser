...
void ThrowCME(stringfmt, ...) __attribute__ ((format (printf, 1, 2)));
...
namespace RawSpeed {
	...
	CameraMetadataException::CameraMetadataException(string _msg) : runtime_error(_msg) {
