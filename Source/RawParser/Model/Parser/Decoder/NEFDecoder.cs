...
namespace RawNet.Decoder
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (wb != null)
                    {
                        ...
                        {
                            uint red = (uint)wb.data[1249] | (((UInt32)wb.data[1248]) << 8);
                            uint blue = (uint)wb.data[1251] | (((UInt32)wb.data[1250]) << 8);
    ...
    new CamRGB(){
        name ="Nikon D3100",
        matrix =new double[,]{ { 7911, -2167, -813 },{ -5327, 13150, 2408 },{ -1288, 2483, 7968 } } },/*
    { "Nikon D3200", 0, 0xfb9,
    ...
    new CamRGB(){
        name ="Nikon D7100",
        matrix =new double[,]{ { 8322 / 1000.0, -3112 / 1000.0, -1047 / 1000.0 },
            { -6367 / 1000.0, 14342 / 1000.0, 2179 / 1000.0 },
            { -988 / 1000.0, 1638 / 1000.0, 6394 / 1000.0 } }
    }
            /*,
    { "Nikon D7200", 0, 0,
    { 8322,-3112,-1047,-6367,14342,2179,-988,1638,6394 } },
